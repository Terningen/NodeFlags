...
export type ClientOptions = {
    baseUrl: 'https://localhost:44306' | (string & {});
};
...
export type PingData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/nodeflags/api/v1/ping';
};
...
export type WhatsMyNameData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/nodeflags/api/v1/whatsMyName';
};
...
export type WhatsTheTimeMrWolfData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/nodeflags/api/v1/whatsTheTimeMrWolf';
};
...
export type WhoAmIData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/nodeflags/api/v1/whoAmI';
};
